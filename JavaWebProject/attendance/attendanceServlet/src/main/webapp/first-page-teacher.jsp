...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <button onclick="myFunction('Demo1')"class="w3-bar-item w3-button w3-padding"><i class="fa fa-bank fa-fw"></i> My teaching subject <i class="fa fa-caret-down"></i></button>
    <a id="Demo1" class="w3-hide w3-button w3-block w3-left-align" href="#tehnologiiinternet" onclick="schimbarecontent(event)">Tehnologii internet - proiect</button>
...
function schimbarecontent(event){
	htmlContent = '<div class="w3-padding-large"><p><button class="w3-btn w3-green">Start attendance</button></p><p><button class="w3-btn w3-green">Stop attendance</button></p><p><button class="w3-btn w3-green">View attendance</button></p></div>';
